                    ...
                    <div class="col">
                      <div class="mb-1">
                        <h3 class="text-secondary">
                          Reporte de Actividad por Departamento
                        </h3>
                      </div>
                        ...
                        <div class="form-group row mt-2">
                          <div class="input-group">
                            ...
                            <select
                              ...
                              v-model="registro.codigo_dep"
                              name="codigo_act"
                              id="codigo_act"
                            >
                              <option :value="null"></option>
                              <option v-for="data in departamentos":value="data.codigo_dep">
                                {{ data.nombre_dep }}
                              </option>
                            </select>
                          </div>
...
export default {
  ...
  methods: {
    search: function (page) {
      axios
        .post("/api/registroporrango?page=".concat(page), this.registro)
        .then(

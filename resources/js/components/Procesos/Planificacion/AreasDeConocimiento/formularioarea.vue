                                ...
                                <div class="col">
                                    ...
                                    <form @submit.prevent="submit">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input required type="text" v-model="area.nombre_area" name="nombre_area" class="form-control" id="nombre_area" placeholder="Materia">
                                                </div>
                                            </div>
...
<script>
    export default {
        ...
        methods:{
            submit:function(){
                axios.post('/api/areas', this.area).then((result) => {
                    console.log(result)
                    window.history.back();
                }).catch((err) => {
                    console.warn(err)

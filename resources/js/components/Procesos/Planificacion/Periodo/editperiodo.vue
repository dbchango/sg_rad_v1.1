                                    ...
                                    <div class="col">
                                        ...
                                        <form @submit.prevent="submit">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Nombre del periodo</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select required class='form-control custom-select' v-model='periodo.activo_per' name="activo_per" id="activo_per">
...
<script>
    export default {
        ...
        methods:{
            submit: function(){
                axios.put('/api/periodos/'.concat(this.$el.id)).then(function(response){

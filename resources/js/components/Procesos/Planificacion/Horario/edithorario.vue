                                    ...
                                    <div class="col">
                                        ...
                                        <form @submit.prevent="submit">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select required maxlength="11" class="form-control custom-select" name="" id="" v-model="horario.codigo_per">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select required class="form-control custom-select" name="codigo_pro" id="codigo_pro" v-model="horario.codigo_pro">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select required class="form-control custom-select" v-model="horario.codigo_dia" name="" id="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="number" v-model="horario.numero_horas_hor" class="form-control" min="1">
                                                </div>
                                            </div>
...
<script>
    export default {
        ...
        methods:{
            submit: function(){
              axios.put('/api/horarios/'.concat(this.$el.id), this.horario)
        ...
        mounted() {
            axios.get('/api/horarios/'.concat(this.$el.id))
                .then(function(response){

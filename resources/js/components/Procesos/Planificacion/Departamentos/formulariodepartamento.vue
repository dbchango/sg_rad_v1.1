                                    ...
                                    <div class="col">
                                        ...
                                        <form @submit.prevent="submit">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input required type="text" v-model="departamento.nombre_dep" name="nombre_dep" class="form-control" id="nombre_dep" placeholder="Departamento">
                                                    </div>
                                                </div>
    ...
    export default {
        ...
        methods:{
            submit: function(){
                ...
                axios.post('/api/departamentos', this.departamento)

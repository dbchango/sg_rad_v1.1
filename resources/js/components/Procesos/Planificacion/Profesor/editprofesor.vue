                                    ...
                                    <div class="col">
                                        ...
                                        <form @submit.prevent="submit">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input v-model="profesor.miespe_pro" class="form-control" id="miespe_pro" placeholder="Usuario MiEspe">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Email:</label>
                                                    <div class="col-sm-8">
                                                        <input required v-model="profesor.email_pro" class="form-control" id="email_pro" placeholder="Email" type="email">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
<script>
    export default {
        ...
        mounted() {
            axios.get('/api/profesores/'.concat(this.$el.id))

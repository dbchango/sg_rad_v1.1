                                ...
                                <div class="col">
                                   ...
                                   <form @submit.prevent="submit">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required v-model="calificacion.cco_nombre" class="form-control" id="cco_nombre" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Valor</label>
                                            <div class="col-sm-8">
                                                <input required  v-model="calificacion.cco_valor" class="form-control" id="cco_valor" type="decimal" >
                                            </div>
                                        </div>
                                        <div class="form-group row mx-auto">
                                            <button type="submit" value="submit" class="btn btn-outline-dark mt-1">Buscar&nbsp;<i class="fas fa-save"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </li>
...
<script>
    export default {
        ...
        methods:{
            submit:function(){
                axios.post('/api/calificacionescoevaluaciones', this.calificacion)

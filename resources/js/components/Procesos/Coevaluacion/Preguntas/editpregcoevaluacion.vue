                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed bg-light">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select required name="codigo_per" id="codigo_per" v-model="pregunta_co.codigo_per" class="form-control custom-select">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required v-model="pregunta_co.pco_numero" class="form-control" id="pea_numero" type="number" min="1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Nombre</label>
                                            <div class="col-sm-8">
                                                <input required  v-model="pregunta_co.pco_nombre" class="form-control" id="pea_nombre" type="text" placeholder="Nombre">
                                            </div>
                                        </div>
...
<script>
    export default {
        ...
        methods:{
            submit: function(){
                axios.put('/api/preguntascoevalauciones/'.concat(this.$el.id), this.pregunta_co)
        ...
        mounted() {
            axios.get('/api/preguntascoevalauciones/'.concat(this.$el.id), this.pregunta_co)
                .then(function(response){
                    this.pregunta_co = response.data
                }.bind(this)).catch(err=>console.warn(err))

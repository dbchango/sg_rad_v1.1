                                ...
                                <div class="col">
                                   ...
                                   <form @submit.prevent="submit">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required v-model="pregunta_co.pco_numero" class="form-control" id="pco_numero" type="number" min="1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Pregunta</label>
                                            <div class="col-sm-8">
                                                <input required  v-model="pregunta_co.pco_nombre" class="form-control" id="pco_nombre" type="text" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
<script>
    ...
    export default {
        ...
        methods:{
            submit:function(){
                axios.post('/api/preguntascoevalauciones', this.pregunta_co)

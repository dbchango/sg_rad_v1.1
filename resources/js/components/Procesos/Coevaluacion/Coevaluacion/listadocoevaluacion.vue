                                            ...
                                            <form @submit.prevent="search">
                                                <div v-if="codigo_opt" class="form-group row mt-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input v-model="coevaluacion.coe_codigo" class="form-control" id="cau_codigo" type="text" placeholder="Código">
                                                    </div>
                                                </div>
                                                ...
                                                <div v-if="evaluador_opt" class="form-group row mt-2">
                                                    <div class="input-group">
                                                        ...
                                                        <select name="codigo_per" id="codigo_per" v-model="coevaluacion.codigo_pro_evaluador" class="form-control custom-select">
                                                            <option :value="null" selected></option>
                                                ...
                                                <div v-if="evaluado_opt" class="form-group row mt-2">
                                                    <div class="input-group">
                                                        ...
                                                        <select name="codigo_per" id="codigo_per" v-model="coevaluacion.codigo_pro_evaluado" class="form-control custom-select">
                                                            <option :value="null" selected></option>
                                                            <option v-for="data in profesores" :value="data.codigo_pro">{{ data.cedula_pro }}</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <table class="table table-hover table-sprite">
                                            ...
                                            <tbody>
                                                <tr v-for='data in coevaluaciones'>
                                                    ...
                                                    <td width="40px">
                                                         <router-link class="btn btn-outline-info btn-sm" :to="{name:'InfoCoevaluacion', params:{ id:data.coe_codigo }}"><i class="fas fa-eye"></i></router-link>
                                                        <router-link class="btn btn-outline-success btn-sm" :to="{name:'EditarCoevaluacion', params:{ id:data.coe_codigo }}"><i class="fas fa-edit"></i></router-link>
        ...
        data() {
            ...
            return {
                ...
                coevaluacion:{
                    coe_codigo:null,
                    codigo_per:null,
                    codigo_pro_evaluador:null,
                    codigo_pro_evaluado:null
                }
            }
        },
        methods:{

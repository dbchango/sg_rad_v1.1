                                    ...
                                    <div class="col">
                                        ...
                                        <form @submit.prevent="submit">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select required v-on:change="getActividades" name="codigo_tact" id="codigo_tact" v-model="registro.codigo_tact" class="form-control custom-select">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select required v-on:change="getTareas" name="codigo_act" id="codigo_act" v-model="registro.codigo_act" class="form-control custom-select">
    ...
    export default {
        ...
        methods:{
            submit: function(page){
                axios.put('/api/profesores/'.concat(this.$el.id), this.profesor).then(function(response){
            ...
            getTareas:function(){
                ...
                .then(function (response) {
                    ...
                    console.warn(this.tareas)
                }.bind(this))
                .catch(err=>console.warn(err));
            }
        },
        mounted() {
            axios.get('/api/registrosactividades/'.concat(this.$el.id))
                .then(function(response){

                                        ...
                                        <table class="table table-hover table-sprite">
                                            ...
                                            <tbody>
                                                <tr v-for='data in evaluaciones'>
                                                    ...
                                                    <td width="40px">
                                                        <router-link class="btn btn-outline-info btn-sm" :to="{name:'InfoAsignarEvalAdm', params:{ id:data.cea_codigo }}"><i class="fas fa-eye"></i></router-link>
                                                        <router-link class="btn btn-outline-success btn-sm" :to="{name:'EditarAsignarEvalAdm', params:{ id:data.cea_codigo }}"><i class="fas fa-edit"></i></router-link>

                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed bg-light">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required v-model="calificacion.cau_nombre" class="form-control" id="cea_nombre" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Valor</label>
                                            <div class="col-sm-8">
                                                <input required  v-model="calificacion.cau_valor" class="form-control" id="cea_valor" type="decimal" >
                                            </div>
                                        </div>
...
<script>
    export default {
        ...
        methods:{
            submit: function(){
                axios.put('/api/calificacionesautoevaluaciones/'.concat(this.$el.id), this.calificacion)

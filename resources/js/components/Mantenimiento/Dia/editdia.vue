                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed bg-light">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required v-model="dia.nombre_dia" class="form-control" id="nombre_dia" type="text" min="1">
                                            </div>
                                        </div>
...
<script>
    export default {
        ...
        methods:{
            submit: function(){
                axios.put('/api/dias/'.concat(this.$el.id), this.dia)
        ...
        mounted() {
            axios.get('/api/dias/'.concat(this.$el.id), this.dia)
                .then(function(response){

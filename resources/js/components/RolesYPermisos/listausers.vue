                                        ...
                                        <table class="table table-hover table-sprite">
                                            ...
                                            <tbody>
                                                <tr v-for='data in users'>
                                                    ...
                                                    <td width="40px">
                                                        <router-link class="btn btn-outline-info btn-sm" :to="{name:'AsignarRolesYPermisosAUsers', params:{ id:data.id }}"><i class="fa fa-unlock" aria-hidden="true"></i></router-link>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

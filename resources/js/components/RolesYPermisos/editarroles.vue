                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed bg-light">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required type="text" v-model="role.name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Ultima actualización</label>
                                            <div class="col-sm-8">
                                                <p>{{ role.updated_at }}</p>
                                            </div>
                                        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            submit: function(){
                axios.put('/api/roles/'.concat(this.$el.id), {  "name": this.role.name, "guard_name": this.role.guard_name, "created_at": this.role.guard_name.created_at, "updated_at": this.role.guard_name.updated_at } )
        ...
        mounted() {
            ...
            axios.get('/api/roles/'.concat(this.$el.id)).then(
                function(response){
